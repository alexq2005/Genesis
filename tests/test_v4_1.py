...
test("Int: temporal_reasoner.save()", '"temporal_reasoner"' in gs)
...
test("Int: schedule_optimizer.save()", '"schedule_optimizer"' in gs)
...
test("Int: trend_forecaster.save()", '"trend_forecaster"' in gs)
