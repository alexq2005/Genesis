...
test("Int: paper_reader.save()", '"paper_reader"' in gs)
...
test("Int: experiment_runner.save()", '"experiment_runner"' in gs)
...
test("Int: insight_synthesizer.save()", '"insight_synthesizer"' in gs)
