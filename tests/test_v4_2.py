...
test("Int: ethical_reasoner.save()", '"ethical_reasoner"' in gs)
...
test("Int: bias_detector.save()", '"bias_detector"' in gs)
...
test("Int: transparency_engine.save()", '"transparency_engine"' in gs)
