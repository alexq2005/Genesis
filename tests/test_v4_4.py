...
test("Int: task_distributor.save()", "self.task_distributor.save()" in gs)
...
test("Int: result_aggregator.save()", "self.result_aggregator.save()" in gs)
...
test("Int: network_manager.save()", "self.network_manager.save()" in gs)
