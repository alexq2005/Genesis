...
test("Int: safe_code_evolver.save()", "self.safe_code_evolver.save()" in gs)
...
test("Int: architecture_evolver.save()", "self.architecture_evolver.save()" in gs)
...
test("Int: module_generator.save()", "self.module_generator.save()" in gs)
